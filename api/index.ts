    ...
    const response = await ai.models.generateContent({
      ...
      config: {
        ...
        responseSchema: {
          ...
          properties: {
            name: { type: Type.STRING, description: "The name of the city or region" },
            country: { type: Type.STRING, description: "The name of the country" },
            summary: { type: Type.STRING, description: "A rich, evocative cultural introduction" },
            localProverb: {
              type: Type.OBJECT,
            ...
            hiddenGems: {
              ...
              items: {
                ...
                properties: {
                  ...
                  howToExperience: { type: Type.STRING },
                  localLegend: { type: Type.STRING }
                }
              }
            },
            experiences: {
              ...
              items: {
                ...
                properties: {
                  ...
                  howToConnect: { type: Type.STRING },
                  culturalEtiquette: { type: Type.STRING }
                }
              }
            },
            events: {
